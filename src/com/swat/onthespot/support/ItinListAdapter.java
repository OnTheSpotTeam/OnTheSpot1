...
public class ItinListAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		/*
		switch(holder.section){
		case OTSDatabase.SECTION_CURRENT:
			holder.sectionName.setText("Current Itinerary");
			break;
		case OTSDatabase.SECTION_PAST:
			holder.sectionName.setText("Past Itinerary");
			break;
		case OTSDatabase.SECTION_CURRENT_CONTENT:
		case OTSDatabase.SECTION_PAST_CONTENT:
		*/
